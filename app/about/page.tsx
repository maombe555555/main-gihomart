        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="text-center">
              <CardHeader>
                <div className="mx-auto w-24 h-24 bg-orange-100 rounded-full flex items-center justify-center mb-4 overflow-hidden">
                  <Image src="/images/amb.jpg" alt="Team Member 2" width={96} height={96} className="object-cover" />
                </div>
            ...
            <Card className="text-center">
              <CardHeader>
                <div className="mx-auto w-24 h-24 bg-orange-100 rounded-full flex items-center justify-center mb-4 overflow-hidden">
                  <Image src="/images/ced.jpg" alt="Team Member 4" width={96} height={96} className="object-cover" />
                </div>
